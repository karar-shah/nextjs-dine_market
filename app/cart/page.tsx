...
import { CartItem, ErrorResponse } from "@/app/interface/interface";
import { ConsoleLogWriter } from "drizzle-orm";

type ApiResponse = CartItem[] | ErrorResponse;
...
export default function CartPage() {
  ...
  if (isLoading) {
    ...
    if ("message" in cartData) {
      return <div className="text-2xl font-bold">Empty Cart</div>;
    } else if (true) {
      console.log(cartData);
      return (
        <>
