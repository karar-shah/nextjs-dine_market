...
export default function MobilePopUp() {
  ...
  return (
    <>
      ...
      <div
        onClick={handleOpen}
        className="fixed right-28 top-16 z-10 lg:hidden"
      >
        {open ? (
          <>
            <svg
      ...
      {/* Dine market logo */}
      <div className="fixed left-28 top-16 z-10 lg:hidden">
        <Image
          src="/Logo.webp"
          height={25}
          width={140}
      ...
      {!open && (
        <div className="lg:hidden flex justify-center items-center h-screen w-full bg-white">
          {/* List of links */}
